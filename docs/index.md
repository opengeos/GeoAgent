...
See the project [README](https://github.com/opengeos/GeoAgent) for installation, provider setup, and quickstarts.

For API details, browse the sections under **API Reference** (generated from the `geoagent` package).

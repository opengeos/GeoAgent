                ...
                if len(data.items) >= 2:
                    ...
                    if 'assets' in first_item and 'assets' in last_item:
                        ...
                        if asset_key:
                            ...
                            m.add_cog_layer(first_url, name="Time Series Start", fit_bounds=True)
                            m.add_cog_layer(last_url, name="Time Series End", fit_bounds=False)
            ...
            try:
                if data.data_type == "raster":
                    ...
                    if 'assets' in item:
                        ...
                        if asset_key and asset_key in item['assets']:
                            asset_url = item['assets'][asset_key]['href']
                            m.add_cog_layer(asset_url, name="Data Layer", fit_bounds=True)

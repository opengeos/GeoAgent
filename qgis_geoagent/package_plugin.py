...
- Root folder renamed from 'open_geoagent' to the target plugin name
...
def package_plugin(
    ...
    Args:
        source_dir: Path to the open_geoagent directory
        output_path: Optional path for the output zip file
        target_name: Name for the root folder in the zip (default: 'open_geoagent')
...
def main():
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output path for the zip file (default: open_geoagent-{version}.zip in the same folder as this script)",
    )
    parser.add_argument(
        "--source",
        "-s",
        type=Path,
        default=None,
        help="Source directory (default: open_geoagent in the same folder as this script)",
    )
    parser.add_argument(
        "--name",
        "-n",
        type=str,
        default="open_geoagent",
        help="Target plugin name for the zip root folder (default: open_geoagent)",
    )
    parser.add_argument(
        "--no-version",
        action="store_true",
    ...
    source_dir = args.source if args.source else script_dir / "open_geoagent"

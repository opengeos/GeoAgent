"""
Update Checker Dialog for OpenGeoAgent
...
class DownloadWorker(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            temp_dir = tempfile.mkdtemp(prefix="open_geoagent_update_")
            ...
            # The structure will be: repo-main/qgis_geoagent/open_geoagent/
            extracted_plugin_dir = None
            for root, dirs, files in os.walk(extract_dir):
                if "metadata.txt" in files and "open_geoagent.py" in files:
...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("OpenGeoAgent Update")
    ...
    def _setup_ui(self):
        ...
        # Header
        header_label = QLabel("OpenGeoAgent Update Checker")
        header_font = QFont()
    ...
    def _on_download_finished(self, install_path):
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"OpenGeoAgent has been updated to version {self.latest_version}.\n\n"
